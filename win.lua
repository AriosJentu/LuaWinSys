...
function cwDestroy(window)
	...
	if isElement(window.Canvas) then
...
function cspDestroy(spane)
	...
	if isElement(spane.Canvas) then
...
function cbDestroy(button)
	...
	if isElement(button.Canvas) then
...
function ctbDestroy(textbox)
	...
	if isElement(textbox.Canvas) then
...
function ccbDestroy(checkbox)
	...
	if isElement(checkbox.Canvas) then
...
function clbDestroy(combo)
	...
	if isElement(combo.Canvas) then
...
function ctpDestroy(tabpan)
	...
	if isElement(tabpan.Canvas) then
...
function cttDestroy(tooltip)
	...
	if isElement(tooltip.Back) then
