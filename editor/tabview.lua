...
TabViewTool:addProperty("Line Height", "spin", {22, 22, 100, 1}, "setLineHeight", "getLineHeight")
TabViewTool:addProperty("Lines Indentation", "spin", {5, 0, 20, 1}, "setIndentation", "getIndentation")
...
TabViewTool:addProperty("Column Width", "spin", {50, 50, Width, 1}, "setColumnWidth", "getColumnWidth")
